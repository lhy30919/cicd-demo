...
한국 주요 도시의 2023년과 2024년 기상 데이터를 비교 분석하고,  
기후 변화(기온 / 강수량 / 변동성)를 시각화한 HTML 리포트를 자동 생성하는 Python 코드를 작성하였다.
## 데이터 추출 방식
- Open-Meteo API를 통해 도시별 위경도 기반 데이터 요청
- 연 단위(2023 / 2024) 기상 데이터 수집
- 주요 추출 항목:
  - 평균 기온 (temperature_2m_mean)
  - 일 강수량 (precipitation_sum)
 ## 결과물 웹페이지
<img width="350" height="350" alt="image" src="https://github.com/user-attachments/assets/3b672da5-eac5-4a8e-8bee-55341e346d2f" />
